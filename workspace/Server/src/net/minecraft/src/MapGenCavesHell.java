...
public class MapGenCavesHell extends MapGenBase {
	...
	protected void func_4105_a(int i1, int i2, byte[] b3, double d4, double d6, double d8, float f10, float f11, float f12, int i13, int i14, double d15) {
		...
		for(boolean z26 = random23.nextInt(6) == 0; i13 < i14; ++i13) {
			...
			if(!z51 && i13 == i25 && f10 > 1.0F) {
				this.func_4105_a(i1, i2, b3, d4, d6, d8, random23.nextFloat() * 0.5F + 0.5F, f11 - (float)Math.PI / 2F, f12 / 3.0F, i13, i14, 1.0D);
				this.func_4105_a(i1, i2, b3, d4, d6, d8, random23.nextFloat() * 0.5F + 0.5F, f11 + (float)Math.PI / 2F, f12 / 3.0F, i13, i14, 1.0D);
				return;
			}

...
public class BlockJukeBox extends BlockContainer {
	...
	public void ejectRecord(World world1, int i2, int i3, int i4, int i5) {
		if(!world1.singleplayerWorld) {
			...
			tileEntityRecordPlayer6.field_28009_a = i5;
	...
	public void func_28035_b_(World world1, int i2, int i3, int i4) {
		if(!world1.singleplayerWorld) {
			...
			int i6 = tileEntityRecordPlayer5.field_28009_a;
			if(i6 != 0) {
				world1.func_28097_e(1005, i2, i3, i4, 0);
				world1.playRecord((String)null, i2, i3, i4);
				tileEntityRecordPlayer5.field_28009_a = 0;

...
public class WorldChunkManager {
	...
	public WorldChunkManager(World world1) {
		this.field_4255_e = new NoiseGeneratorOctaves2(new Random(world1.getRandomSeed() * 9871L), 4);
		this.field_4254_f = new NoiseGeneratorOctaves2(new Random(world1.getRandomSeed() * 39811L), 4);
		this.field_4253_g = new NoiseGeneratorOctaves2(new Random(world1.getRandomSeed() * 543321L), 2);
	}
	...
	public BiomeGenBase getBiomeGenAt(int i1, int i2) {
		return this.func_4065_a(i1, i2, 1, 1)[0];
	}
	...
	public double[] getTemperatures(double[] d1, int i2, int i3, int i4, int i5) {
		...
		d1 = this.field_4255_e.func_4101_a(d1, (double)i2, (double)i3, i4, i5, 0.02500000037252903D, 0.02500000037252903D, 0.25D);
		this.field_4257_c = this.field_4253_g.func_4101_a(this.field_4257_c, (double)i2, (double)i3, i4, i5, 0.25D, 0.25D, 0.5882352941176471D);
		int i6 = 0;

		for(int i7 = 0; i7 < i4; ++i7) {
			for(int i8 = 0; i8 < i5; ++i8) {
				double d9 = this.field_4257_c[i6] * 1.1D + 0.5D;
				double d11 = 0.01D;
				double d13 = 1.0D - d11;
	...
	public BiomeGenBase[] loadBlockGeneratorData(BiomeGenBase[] biomeGenBase1, int i2, int i3, int i4, int i5) {
		...
		this.temperature = this.field_4255_e.func_4101_a(this.temperature, (double)i2, (double)i3, i4, i4, 0.02500000037252903D, 0.02500000037252903D, 0.25D);
		this.humidity = this.field_4254_f.func_4101_a(this.humidity, (double)i2, (double)i3, i4, i4, (double)0.05F, (double)0.05F, 0.3333333333333333D);
		this.field_4257_c = this.field_4253_g.func_4101_a(this.field_4257_c, (double)i2, (double)i3, i4, i4, 0.25D, 0.25D, 0.5882352941176471D);
		int i6 = 0;

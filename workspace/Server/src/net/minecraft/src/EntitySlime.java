...
public class EntitySlime extends EntityLiving implements IMob {
	...
	public void writeEntityToNBT(NBTTagCompound nBTTagCompound1) {
		...
		nBTTagCompound1.setInteger("Size", this.func_25027_m() - 1);
	}
	...
	public boolean getCanSpawnHere() {
		...
		return (this.func_25027_m() == 1 || this.worldObj.difficultySetting > 0) && this.rand.nextInt(10) == 0 && chunk1.func_334_a(987234911L).nextInt(10) == 0 && this.posY < 16.0D;
	}
